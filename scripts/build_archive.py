...
# These implementation and documentation paths form the closure of the public
# runner, calibration, quality, and identity workflows. They remain part of
# the release even where a legacy filename includes an analysis-oriented term.
SOURCE_RELEASE_REQUIRED_PATHS = frozenset(
    {
